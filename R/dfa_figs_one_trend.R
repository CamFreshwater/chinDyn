...
# Updated Feb 28 for one trend models
...
surv_tbl <- readRDS(here::here("data", "survival_fits", "surv_tbl_onetrend.RDS"))
...
gen_tbl <- readRDS(here::here("data", "generation_fits", "gen_tbl_onetrend.RDS"))
...
# export all figures
png(here::here("figs", "ms_figs", "survival_fit_ar1_onetrend.png"), 
    height = 11.5, 
    width = 10, res = 300, units = "in")
cowplot::plot_grid(surv_fit_panel)
dev.off()

png(here::here("figs", "ms_figs", "survival_fit_real_ar1_onetrend.png"), 
    height = 11.5, 
    width = 10, res = 300, units = "in")
cowplot::plot_grid(real_surv_fit_panel)
dev.off()

png(here::here("figs", "ms_figs", "age_fit_ar1_onetrend.png"), 
