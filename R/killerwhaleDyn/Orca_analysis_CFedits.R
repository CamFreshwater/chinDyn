...
NRKW_Females_YOB <- read.csv(here("data", "NRKW_Females_YOB.csv"),
                             stringsAsFactors = FALSE,
                             strip.white = TRUE,
                             na.strings =c("NA"))

NRKW_Calved <- read.csv(here("data", "NRKW_Calved_since_1980.csv"),
                        stringsAsFactors = FALSE,
                        strip.white = TRUE,
                        na.strings =c("NA"))

SRKW_Live_Females <- read.csv(here("data", "SRKW_Live_Females_since_1980.csv"),
                              stringsAsFactors = FALSE,
                              strip.white = TRUE,
                              na.strings =c("NA"))


SRKW_Females_YOB <- read.csv(here("data", "SRKW_Females_YOB.csv"),
                             stringsAsFactors = FALSE,
                             strip.white = TRUE,
                             na.strings =c("NA"))

SRKW_Calved <- read.csv(here("data", "SRKW_Calved_since_1980.csv"),
                        stringsAsFactors = FALSE,
                        strip.white = TRUE,
                        na.strings =c("NA"))

Salmon_since_1980 <- read.csv(here("data", "Salmon_since_1980.csv"),
                              stringsAsFactors = FALSE,
                              strip.white = TRUE,
                              na.strings =c("NA"))
...
ageMod <- glm(Calved ~ poly(Age, 4), family=binomial, #link="logit" is redundant 
              data=glmData)
